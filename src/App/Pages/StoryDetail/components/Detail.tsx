    ...
    <div className="px-4 md:px-8 lg:px-16 py-12">
      ...
      <div className="text-center mt-6 md:mt-10">
        <p className=" text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
          In a faraway land, nestled between rolling hills, there stood a small stone cottage. It was home to an
          elderly mother goat who lived peacefully with her seven precious little kids, each one more special than
          the last.
        </p>
      </div>
